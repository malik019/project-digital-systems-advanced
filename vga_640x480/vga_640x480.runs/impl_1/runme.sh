...
HD_PWD='C:/Pandora/DSD/vga_640x480/vga_640x480.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_640x480.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_640x480.tcl -notrace
