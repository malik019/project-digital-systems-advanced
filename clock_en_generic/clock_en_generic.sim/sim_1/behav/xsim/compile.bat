...
REM
REM Generated by Vivado on Thu Oct 09 20:13:24 +0200 2025
...
echo "xvhdl --incr --relax -prj clock_en_generic_tb_vhdl.prj"
call xvhdl  --incr --relax -prj clock_en_generic_tb_vhdl.prj -log xvhdl.log
